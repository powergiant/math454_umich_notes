...
\end{equation}
\end{proposition}
\begin{proof} $J_m\left(x x_{n}\right)$ are solutions of the following equation. 
...
In (3.13), nontrivial solutions are obtained when (i) $\mu>0, \sqrt{\mu}=1,2, \cdots$, and (ii) $\mu=0:$
...
Heat flow in the infinite cylinder ${ }^4$
